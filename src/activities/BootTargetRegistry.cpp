...
constexpr std::array<MetaEntry, 6> kMeta = {{
...
constexpr std::array<MakeFn, 6> kMakers = {
    nullptr, &makeClock, &makeHttpMonitor, &makeBatteryMonitor, &makeFileBrowser, &makeCalculator,
};
