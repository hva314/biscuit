...
static constexpr RadarNode kRadarNodes[8] = {
    ...
    {"TOOLS", 33}, {"GAMES", 11},   {"READER", 5},   {"SETTINGS", 7},
};
      ...
      switch (selectorIndex) {
        ...
        case 4: {
          std::vector<AppCategoryActivity::AppEntry> e = {
              ...
              {"HTTP Monitor", "Live server dashboard over HTTP", UIIcon::Wifi,
               [](GfxRenderer& r, MappedInputManager& m) { return std::make_unique<HttpMonitorActivity>(r, m); }, false,
               []() -> bool { return Storage.exists("/biscuit/monitor.conf"); }},
